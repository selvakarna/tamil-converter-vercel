document.addEventListener('DOMContentLoaded', function() {
    ...
    // CHANGED: store base64 audio instead of a server file path
    // (Vercel serverless functions have an ephemeral filesystem — no saved files)
    ...
    function processImage(file) {
        ...
        .then(data => {
            ...
            // CHANGED: audio arrives as base64 inside the JSON
            currentAudioBase64 = data.audio_base64 || '';
            audioPlayer.src = 'data:audio/mpeg;base64,' + currentAudioBase64;
            audioPlayer.play().catch(function() {});   // autoplay may be blocked — that's OK
    ...
    // CHANGED: download converts base64 -> blob entirely in the browser
    // (there is no /download route anymore)
    ...
    downloadAudioBtn.addEventListener('click', function() {
        ...
        const url = URL.createObjectURL(base64ToBlob(currentAudioBase64, 'audio/mpeg'));
        const a = Object.assign(document.createElement('a'), {
            href: url,
            download: 'tamil-audio.mp3'
        });
